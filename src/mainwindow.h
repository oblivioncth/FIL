...
private:
    ...
    std::unique_ptr<LaunchBoxInstall> mLaunchBoxInstall;
    std::unique_ptr<FlashpointInstall> mFlashpointInstall;
...
private:
    ...
    QStringList getSelectedPlaylists();
    UpdateMode getSelectedUpdateMode();
    void importProcess();
