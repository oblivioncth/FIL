...
Currently the following fields will be populated for each game, which is limited by what is available within Flashpoint:
...
This section is subject to change as support for more launchers is added.
