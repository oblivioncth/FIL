...
//-Constructor--------------------------------------------------------------------------------------------------------
protected:
    explicit UpdateableDoc(Install* const parent, const QString& docPath, QString docName, const Import::UpdateOptions& updateOptions);
...
//-Constructor--------------------------------------------------------------------------------------------------------
protected:
    explicit PlatformDoc(Install* const parent, const QString& docPath, QString docName, const Import::UpdateOptions& updateOptions);
...
//-Constructor--------------------------------------------------------------------------------------------------------
protected:
    explicit BasicPlatformDoc(Install* const parent, const QString& docPath, QString docName, const Import::UpdateOptions& updateOptions);
...
//-Constructor--------------------------------------------------------------------------------------------------------
protected:
    explicit PlaylistDoc(Install* const parent, const QString& docPath, QString docName, const Import::UpdateOptions& updateOptions);
...
//-Constructor--------------------------------------------------------------------------------------------------------
protected:
    explicit BasicPlaylistDoc(Install* const parent, const QString& docPath, QString docName, const Import::UpdateOptions& updateOptions);
...
/*
 * Not used by base implementation, but useful for multiple launchers
 */
class XmlDocReader : public virtual DataDoc::Reader
{
//-Instance Variables--------------------------------------------------------------------------------------------------
protected:
    QFile mXmlFile;
...
//-Constructor--------------------------------------------------------------------------------------------------------
public:
    XmlDocReader(DataDoc* targetDoc, const QString& root);
...
class XmlDocWriter : public virtual DataDoc::Writer
{
//-Instance Variables--------------------------------------------------------------------------------------------------
protected:
    QFile mXmlFile;
...
//-Constructor--------------------------------------------------------------------------------------------------------
public:
    XmlDocWriter(DataDoc* sourceDoc, const QString& root);
